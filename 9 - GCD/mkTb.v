...
//
// On Mon Apr 19 23:34:14 IST 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkTb(CLK,
  ...
  // register gcdVariable_flag
  reg gcdVariable_flag;
  wire gcdVariable_flag$D_IN, gcdVariable_flag$EN;
  ...
  wire WILL_FIRE_RL_action_l13c20,
       WILL_FIRE_RL_action_l14c9,
       WILL_FIRE_RL_fsm_start,
       WILL_FIRE_RL_idle_l12c17;
  ...
  // rule RL_action_l14c9
  assign WILL_FIRE_RL_action_l14c9 =
	     gcdVariable_flag && gcdVariable_x == 32'd0 &&
  ...
  // rule RL_idle_l12c17
  assign WILL_FIRE_RL_idle_l12c17 =
	     !start_wire$whas && state_mkFSMstate == 3'd2 ;

  // rule RL_action_l13c20
  assign WILL_FIRE_RL_action_l13c20 =
	     !gcdVariable_flag && start_wire$whas &&
  ...
  assign state_set_pw$whas =
	     WILL_FIRE_RL_idle_l12c17 || WILL_FIRE_RL_action_l14c9 ||
	     WILL_FIRE_RL_action_l13c20 ;

  // register gcdVariable_flag
  assign gcdVariable_flag$D_IN = !WILL_FIRE_RL_action_l14c9 ;
  assign gcdVariable_flag$EN =
	     WILL_FIRE_RL_action_l14c9 || WILL_FIRE_RL_action_l13c20 ;
  ...
  // register gcdVariable_y
  assign gcdVariable_y$D_IN = WILL_FIRE_RL_action_l13c20 ? y : gcdVariable_x ;
  ...
  // register state_mkFSMstate
  always@(WILL_FIRE_RL_idle_l12c17 or
	  WILL_FIRE_RL_action_l13c20 or WILL_FIRE_RL_action_l14c9)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_idle_l12c17: state_mkFSMstate$D_IN = 3'd0;
      WILL_FIRE_RL_action_l13c20: state_mkFSMstate$D_IN = 3'd1;
      WILL_FIRE_RL_action_l14c9: state_mkFSMstate$D_IN = 3'd2;
      default: state_mkFSMstate$D_IN = 3'b010 /* unspecified value */ ;
    endcase
  end
  assign state_mkFSMstate$EN =
	     WILL_FIRE_RL_idle_l12c17 || WILL_FIRE_RL_action_l13c20 ||
	     WILL_FIRE_RL_action_l14c9 ;
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        gcdVariable_flag <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	x <= `BSV_ASSIGNMENT_DELAY 32'd1034;
	y <= `BSV_ASSIGNMENT_DELAY 32'd4975;
      end
    else
      begin
        if (gcdVariable_flag$EN)
	  gcdVariable_flag <= `BSV_ASSIGNMENT_DELAY gcdVariable_flag$D_IN;
	if (gcdVariable_x$EN)
  ...
  begin
	...
	$finish(32'd0);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l13c20 && WILL_FIRE_RL_action_l14c9)
	$display("Error: \"tb.bsv\", line 13, column 20: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l13c20] and\n  [RL_action_l14c9] ) fired in the same clock cycle.\n");
  end
  // synopsys translate_on
endmodule  // mkTb
