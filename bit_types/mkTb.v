...
//
// On Sat Apr 10 11:05:02 IST 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkTb(CLK,
  ...
  wire [15 : 0] IF_int16_1_BIT_15_2_THEN_NEG_int16_1_3_ELSE_in_ETC___d15;

  // register int16
  assign int16$D_IN =
	     int16[15] ?
	       -IF_int16_1_BIT_15_2_THEN_NEG_int16_1_3_ELSE_in_ETC___d15 :
	       IF_int16_1_BIT_15_2_THEN_NEG_int16_1_3_ELSE_in_ETC___d15 ;
  ...
  // remaining internal signals
  assign IF_int16_1_BIT_15_2_THEN_NEG_int16_1_3_ELSE_in_ETC___d15 =
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd0) $display("foo = %x", $unsigned(16'd1));
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd0) $display("foo = %x", $unsigned(16'd1));
    if (RST_N != `BSV_RESET_VALUE)
